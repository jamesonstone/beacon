        ...
        .popover(isPresented: $isPresented, arrowEdge: .bottom) {
            ScrollView {
                VStack(alignment: .leading, spacing: 13) {
                    ...
                    taxonomyRow("Order", symbol: "line.3.horizontal", text: "Within each status, projects stay together and show Pull Requests first, Issues next, and Local or Manual lanes last. Drag reorders within the same project and work-item type; drop on Following or Parking Lot only to Resume or Ignore.", accent: BeaconThemePreference.current().tokens.textSecondary.color)
